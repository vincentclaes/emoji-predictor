...
- [02-fine-tune-with-CLIP-on-train-dataset-tweets.ipynb](./02-fine-tune-with-CLIP-on-train-dataset-tweets.ipynb): Use the pretrained CLIP model and incrementally train it on bigger samples. We start with 1, 5, 10, ... up to 500 samples per emoji.
